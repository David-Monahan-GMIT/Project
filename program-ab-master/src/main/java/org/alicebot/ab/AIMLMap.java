 ...
 * 
 * This Class is used for mapping String sets and is primarily used to parse the
 * Bots map file and allow the Bot to parse multiple ways of saying the same
 * thing.
 * e.g 
 * ma:mother
 * mom:mother
