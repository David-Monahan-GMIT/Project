...
*/
/**
 * Primary class for creating a Chat interface between a Bot and a user. This
 * class essentially is the interface between the users input and the Bot's
 * datasets. 
 * 
 * @author Dave
 *
...
public class Chat {
	...
	public String multisentenceRespond(String request) {
		...
		matchTrace = "";
		/*
		 * thatHistory.printHistory(); inputHistory.printHistory();
		 * requestHistory.printHistory(); responseHistory.printHistory();
		 */
		try {
