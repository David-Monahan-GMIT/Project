...
public class AIMLProcessor {
	 ...
	 * @param topic
	 *            value of topic in case this category is wrapped in a <topic>
	 *            tag
	 * @param aimlFile
	 ...
	 * @param ps
	 *            current parse state.
	 * @return the result of processing the srai tag
	 *
	 */
	 ...
	 * individual characters (separated by spaces). Explode "ABC DEF" = "A B C D
	 * E F".
	 *
	 * @param node
	 *            current XML parse node
	...
	/**
	 * evaluate tag contents and capitalize each word. implements
	 * {@code <formal>} tag
	 *
	 * @param node
	 *            current XML parse node
