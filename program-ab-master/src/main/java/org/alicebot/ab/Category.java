...
/**
 * Class to handle AIML Categories. A Category is a fundamental unit of
 * information in AIML. Each Category has to contain a Pattern and a Template.
 * The Pattern is the user input to try and match and the Template is the
 * information to be used to form a response.
 * 
 * @author Dave
 *
 */
public class Category {
	...
	/**
	 * return a string representing the full pattern path as
