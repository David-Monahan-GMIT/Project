 ...
 * 
 * AIML Sets are large lists of values with common typing. For example one set
 * in S.U.P.E.R is just a list of Colours another is a list of names. This
 * allows the bot to identify what is being specified in different statements.
 * 
 */
	...
	public int readAIMLSetFromInputStream(InputStream in, Bot bot) {
		...
		try {
			while ((strLine = br.readLine()) != null && strLine.length() > 0) {
				 ...
				 * "ISA"+setName.toUpperCase()+" "+strLine.toUpperCase(), "*",
				 * "*", "true", MagicStrings.null_aiml_file);
